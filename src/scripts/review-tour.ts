...
function initTour() {
  ...
  const STOPS: Stop[] = [
    ...
    { id: 'home-statement', page: '/', label: 'Statement quote', selector: '.statement .serif',
      pills: ['Every escrow closes twice: once on paper, once in someone’s life. (owner approved)'] },
    ...
    { id: 'agents-h1', page: '/agents', label: 'Agents page headline', selector: '.hero h1',
      pills: ['Your client. Your relationship. Our paperwork.', 'You keep the relationship. We keep the dates.'] },
    ...
    { id: 'investors-h1', page: '/investors', label: 'Investors page headline', selector: '.hero h1',
      pills: ['Bring the hard ones.', 'Complex files, run as regular work.'] },
